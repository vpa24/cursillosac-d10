 ...
 * @endcode
 */
$settings['hash_salt'] = '3EKB_ZuRUFk4vTXKXztKHcdCCFmTtK0jYnOYNAKk50OKL61SE-COZBGD8CGdXfMdFSTA8erjEg';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_cursillosac_d10_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_cursillosac_d10_dd.inc';
}
// </DDSETTINGS>
$databases['default']['default'] = array (
  'database' => 'cursillosac_d10',
  'username' => 'root',
  'password' => '',
  'prefix' => '',
  'host' => '127.0.0.1',
...
//   'driver' => 'mysql',
// ];
$settings['config_sync_directory'] = 'sites/cursillosac-d10.dd/files/config_4NQ5XeMXENGJcfxDB2qX-ygH3S7pszfWlAEkDdin4-1gW75rw2BtodIJqk3_plgkwJTNgKNAkQ/sync';
